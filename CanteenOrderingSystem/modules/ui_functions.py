...
from . import Settings,AbstractMainWindow
...
class UIFunctions(AbstractMainWindow):
    # MAXIMIZE/RESTORE
    # ///////////////////////////////////////////////////////////////
    ...
    def toggleLeftBox(self, enable):
        if enable:
            ...
            if width == 0:
                ...
                if widthRightBox != 0:
                    style = self.accountTopBtn.styleSheet()
                    self.accountTopBtn.setStyleSheet(style.replace(Settings.BTN_RIGHT_BOX_COLOR, ''))
            else:
                widthExtended = standard
                # RESET BTN
    ...
    def toggleRightBox(self, enable):
        if enable:
            ...
            if width == 0:
                widthExtended = maxExtend
                # SELECT BTN
                self.accountTopBtn.setStyleSheet(style + color)
                if widthLeftBox != 0:
                    style = self.toggleLeftBox.styleSheet()
                ...
                widthExtended = standard
                # RESET BTN
                self.accountTopBtn.setStyleSheet(style.replace(color, ''))
